...
with col3:
    ...
    st.markdown("Load your image and view the results")
st.markdown("----------------------------------------------------------------")
    ...
    if len(faces) > 0:
        ...
        for i in range(len(faces)):
            ...
            if mask_result == 0:
                ...
                cv2.putText(out_img,"Without Mask",(x, y-10), cv2.FONT_HERSHEY_DUPLEX,1,(255,51,51),2)
